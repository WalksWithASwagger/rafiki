...
| `prompts/bcai/rap-cohort-2-week-3-youtube-thumbnail.md` | RAP Cohort 2 Week 3 YouTube thumbnail | `## N.` sections + `**Prompt:**` blockquotes | Yes | Generative bioluminescent pass; use `rap-cert.png` + BC+AI logo with `--reference-role brand`. See `docs/HANDOFF-2026-06-09-youtube-thumbnails.md`. |
| `prompts/bcai/rap-cohort-feature-graphics-2026-native-2026-06-06.md` | RAP future cohort enrollment promo (Luma feature graphics) | `## N.` sections + `**Prompt:**` blockquotes | Yes | 20 native graphics for Aug 7 C2 + Sept 18 C3 enrollment; use `rap-shield.png` + BC+AI logo. Output: `output/rap-cohort-feature-graphics-2026-native/`. |
| `prompts/bcai/animation-accelerator-cohort-2-week-1-youtube-thumbnail.md` | Animation Accelerator Week 1 plaque recipe | `## N.` sections + `**Prompt:**` blockquotes | Yes | Reconstructed north-star recipe from committed Week 1 assets. |
| `prompts/bcai/animation-accelerator-cohort-2-week-3-youtube-thumbnail.md` | Animation Accelerator Cohort 2 Week 3 YouTube thumbnail | `## N.` sections + `**Prompt:**` blockquotes | Yes | Generative plaque pass from Week 1 recipe; `gpt-image-2`, no overlays. |
