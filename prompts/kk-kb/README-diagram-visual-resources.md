# Diagram & visual resources (index)

| Document | What it is |
|----------|------------|
| [ai-diagram-pipeline-teaching-kit.md](./ai-diagram-pipeline-teaching-kit.md) | **Talk:** 15 min + 10 min exercise, one-paragraph summary, ethics, Google Photos links |
| [custom-gpt-diagram-gardener-and-weaver.md](./custom-gpt-diagram-gardener-and-weaver.md) | **Custom GPT** system prompts: prompt gardener + image weaver |
...
| [waiff-brazil-2026-keynote-image-prompts.md](./waiff-brazil-2026-keynote-image-prompts.md) | **WAIFF Brasil 2026** keynote — zine **slide** prompts (Gemini, full deck + later-session adds + notes) |
| [wikipedia-five-futures-image-prompts-archive.md](./wikipedia-five-futures-image-prompts-archive.md) | **Wikipedia “Five Futures”** — Midjourney `/imagine` set + master/subtheme prompts + keyword lists |
...
- `gni-journalism-sovereignty/hopecode-style-guide.txt`  
- HOPECODE / BC+AI also in `rafiki/prompts/bcai/` (sibling repo)

*Index: 2026-04-27 — lives under **Rafiki** `prompts/kk-kb/` (KK diagram + image prompt archive).*
