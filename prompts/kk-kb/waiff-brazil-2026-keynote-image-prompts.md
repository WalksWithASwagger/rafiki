...
## Original slide prompts (deck v1 — slides 01–15)

### 01. Title slide — “How to Keep Our Souls Intact”
...
### 02. Binary trap — Boosters vs doomers
...
### 06. Better humans not better machines
...
*Numbering below matches iteration labels in the deck work, not the 01–15 sequence above. Slides named `07`/`08`/`09`/`11` here are **additional** variants, not replacements for the main deck unless explicitly swapped in post.*

### 06b. Stop saying bias
...
### 13b. Loops / intuition (Matt Lambert)
